...
<title>Login - Apotek Friendly</title>
...
<body class="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100 flex items-center justify-center p-4">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2">Sistem Informasi Apotek</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-2xl shadow-emerald-100 p-8 border border-gray-100">
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-500">
                    Belum punya akun? 
                    <a href="<?= site_url('auth/register') ?>" class="text-emerald-600 font-semibold hover:text-emerald-700 hover:underline transition-all">
                        Daftar Sekarang
                    </a>
                </p>
            </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-gray-400 text-sm">
                    Karyawan? 
                    <a href="<?= site_url('karyawan/auth') ?>" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-all">
                        Login Karyawan
                    </a>
                </p>
            </div>
